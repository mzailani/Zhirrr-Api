...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/628881277513 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat gw aja yaaa di wa.me/628881277513 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'zailanigans') return res.json(loghandler.invalidKey)
...
router.get('/textmaker/anime', async (req, res, next) => {
	...
	if(apikeyInput != 'zailanigans') return res.json(loghandler.invalidKey)
        ...
        if (theme != 'underwater' && theme != 'naruto-banner') return res.json(loghandler.notheme)
        if (!text) return res.json(loghandler.nottext)
